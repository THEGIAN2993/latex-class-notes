...
\begin{theorem}[Green's Formulas]
	...
	\begin{enumerate}[label = (\alph*),itemsep=1pt,topsep=3pt]
        ...
        \item $\ds \int_U Dv \cdot Du dx = -\int_U (\Delta v)u\,dx + \int_{\partial U}\frac{\partial u}{\partial \nu} u\,dS$, 
        \item $\ds \int_U u \Delta v - v \Delta u\,dx = \int_{\partial U} u\frac{\partial v}{\partial \nu} - v \frac{\partial u}{\partial \nu}\,dS$.
    \end{enumerate}
\end{theorem}
	
\section{Polar Coordinates in $\bfR^n$ }
...
\begin{definition}
	...
	\begin{enumerate}[label = (\alph*),itemsep=1pt,topsep=3pt]
		...
		\item For all $\epsilon > 0$, define $\eta_\epsilon(x) := \frac{1}{\epsilon^n}\eta\left( \frac{x}{\epsilon}\right)$.
	\end{enumerate}
\end{definition}

\begin{remark}
	The standard mollifier is a radial function.
\end{remark}

\begin{proposition}
	\mbox{}
	\begin{enumerate}[label = (\alph*),itemsep=1pt,topsep=3pt]
		\item $\eta_\epsilon \in C_c^\infty(\bfR^n)$;
...
\begin{theorem}
	Let $U \subset \bfR^n$ be open and $f \in \Loc^1(U)$. Define $U_\epsilon := \{y \in U : \epsilon <  \dist(y,\partial U)\}$ and $f^{\epsilon}(x) := (f \ast \eta_\epsilon)(x)$. Then:
	\mbox{}
	\begin{enumerate}[label = (\alph*),itemsep=1pt,topsep=3pt]
